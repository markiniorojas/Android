  ...
  return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Gestiona tus Modulos</Text>
        </View>
  
        <TouchableOpacity style={styles.addButton} onPress={() => navigation.navigate("ModuleRegister")}>
          <Text style={styles.addButtonText}>+ Agregar Modulos</Text>
        </TouchableOpacity>
  
        <ScrollView style={styles.listContainer} showsVerticalScrollIndicator={false}>
          {modules.length === 0 ? (
            <View style={styles.emptyState}>
              <Text style={styles.emptyTitle}>No hay Modulo</Text>
              <Text style={styles.emptySubtitle}>Crea tu primer Modulo para comenzar</Text>
            </View>
          ) : (
            modules.map((item) => (
