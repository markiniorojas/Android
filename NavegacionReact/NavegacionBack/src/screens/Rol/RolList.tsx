    ...
    Alert.alert(
      ...
      [
        { text: "Cancelar", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              await deleteEntity(id, "Rol", "Logical");
 ...
 return (
        <View style={styles.container}>
          <View style={styles.header}>
            ...
            <Text style={styles.headerSubtitle}>Gestiona tus Rol</Text>
          </View>
          ...
          <ScrollView style={styles.listContainer} showsVerticalScrollIndicator={false}>
            {roles.length === 0 ? (
              <View style={styles.emptyState}>
                <Text style={styles.emptyTitle}>No hay Rol</Text>
                <Text style={styles.emptySubtitle}>Crea tu primer Rol para comenzar</Text>
              </View>
            ) : (
              roles.map((item) => (
